...
with DAG(
    ...
    schedule="30 9 7,17,27 * *",  # 每月 7, 17, 27 號的 09:30
    ...
    crawl_cpt_fx_task >> gen_fx_to_other_currencies_task >> clean_data_for_sap_task >> write_data_to_sap_task >> gen_attchments_task
