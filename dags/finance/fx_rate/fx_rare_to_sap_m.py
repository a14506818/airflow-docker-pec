...
with DAG(
    ...
    schedule="30 9 1,11,21 * *",  # 每月 1, 11, 21 號的 09:30
    ...
    crawl_oanda_fx_task >> gen_fx_to_other_currencies_task >> clean_data_for_sap_task >> write_data_to_sap_task >> gen_attchments_task
    crawl_oanda_fx_task >> clean_data_for_bpm_task >> write_data_to_bpm_task
